function LifeExpectancy() {
  ...
  this.name = 'Life Expectancy: 1974-2019';

  // Each visualisation must have a unique ID with no special
  // characters.
  this.id = 'lifeexpetancy-timeseries';

  // Title to display above the plot.
  this.title = 'Life expectancy at birth for males and females, UK, between 1980 and 2017';
  ...
  this.preload = function() {
    var self = this;
    this.data = loadTable(
      './data/life-expectancy/life-expectancy.csv', 'csv', 'header',
...
//        }
    ...
    this.minPercentage = 70;         // Pay equality (zero pay gap).
    this.maxPercentage = 85;
  };
...
//                    text(legend[j], 100 ,this.mapYToHeight(current.percentage) -20) 
                    text(l, 100, this.mapPayGapToHeight(current.percentage) + 20)
//                    pop();
                  }
